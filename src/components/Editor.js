...
//search
    ...
    const Editor = ({ socketRef, roomId, onCodeChange }) => {
        ...
        const lang = useRecoilValue(language); // Replace with your Recoil atom
        const editorTheme = useRecoilValue(cmtheme); // Replace with your Recoil atom
        ...
        useEffect(() => {
            if (socketRef.current) {
                console.log("Sent message is this")
